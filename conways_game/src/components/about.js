        ...
        <div >
            ...
            <section>
                ...
                <section className='still_lifes'>
                    ...
                    <h2>Beehive</h2>
                    <p>Beehive is a 6-cell still life. It can be seen as a weld of two tubs. It was found by the JHC group in 1970. </p>
                    <img src={loaf} alt={'loaf'}/>
                    <h2>Loaf</h2>
                    <p>Loaf is a 7-cell still life discovered by the JHC group in 1970. It can be seen as a weld of two beehives.</p>
                    <img src={boat} alt='boat'/>
                    <h2>Boat</h2>
                    <p>The boat is the only still life with 5 cells and was discovered by the JHC group in 1970. It can be thought of as a tub with an extra cell in one of the corners, or a ship with one of the corner cells removed. Like the tub and the ship, it is infinitely extensible.</p>
                    <img src={tub} alt='tub'/>
                    <h2>Tub</h2>
                    <p>The tub is one of only two 4-cell still lifes (the other being the block) and was discovered by the JHC group in 1970.
